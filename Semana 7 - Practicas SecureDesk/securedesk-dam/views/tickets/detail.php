        ...
        <?php else: ?>
            ...
            <form method="POST" action="">
                ...
                <div style="display: flex; gap: 15px; align-items: center; margin-top: 20px;">
                    ...
                    <?php if ($_SESSION['role'] !== 'lector'): ?>
                        <a href="export_ticket.php?id=<?= $ticket['id'] ?>" class="btn-secondary" target="_blank">📄 Exportar informe</a>
                    <?php endif; ?>
                     <a href="export_ticket_pdf.php?id=<?= $ticket['id'] ?>" class="btn-secondary" target="_blank">📥 Exportar PDF</a>
                    <a href="tickets_view.php" class="btn-back">← Volver al listado</a>
                </div>
            </form>
        <?php endif; ?>
