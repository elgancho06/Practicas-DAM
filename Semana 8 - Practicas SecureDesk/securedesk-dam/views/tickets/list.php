...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-actions">
            ...
            if ($_SESSION['role'] !== 'lector'): ?>
                <a href="../tickets/ticket_create.php" class="btn-create">
                    + Nuevo ticket
                </a>
            <?php endif; ?>

            <!-- Botón de exportar CSV (visible para todos los autenticados) -->
            <a href="../exports/export_tickets_csv.php?status=<?= urlencode($status ?? '') ?>&priority=<?= urlencode($priority ?? '') ?>&q=<?= urlencode($q ?? '') ?>" class="btn-secondary">
                📥 Exportar CSV
            </a>
        </div>
    </div>
    ...
    <form method="GET" class="filters">
        ...
        <div class="filter-group search-group">
            ...
            <input type="text" name="q" id="q" placeholder="Título o descripción..." 
        ...
        <a href="tickets_view.php" class="btn-clear">🗑️ Limpiar</a>
    </form>
    ...
    <table class="tickets-table">
        ...
        <?php else: ?>
            <?php foreach ($tickets as $ticket): ?>
                <tr>
                    <td>
                        <a href="../tickets/ticket_detail.php?id=<?= $ticket['id'] ?>">
