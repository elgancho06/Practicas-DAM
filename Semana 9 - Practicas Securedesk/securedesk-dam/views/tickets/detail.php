...
<div class="detail-wrapper">
    ...
    <div class="detail-card">
        ...
        <?php if ($_SESSION['role'] === 'lector'): ?>
            ...
            <div style="display: flex; gap: 15px; align-items: center; margin-top: 20px;">
                <a href="<?= $baseUrl ?>exports/export_ticket.php?id=<?= $ticket['id'] ?>" class="btn-secondary" target="_blank">📄 Exportar informe</a>
                <a href="<?= $baseUrl ?>exports/export_ticket_pdf.php?id=<?= $ticket['id'] ?>" class="btn-secondary" target="_blank">📥 Exportar PDF</a>
                <a href="<?= $baseUrl ?>tickets/tickets_view.php" class="btn-back">← Volver al listado</a>
            </div>
    ...
    <div class="detail-card">
                ...
                <?php foreach ($attachments as $file): ?>
                    <div class="attachment-card">
                        ...
                        <div class="file-actions">
                            <a href="<?= $baseUrl ?>uploads/download_attachment.php?id=<?= $file['id'] ?>" class="btn-download">Descargar</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        <?php if ($_SESSION['role'] !== 'lector'): ?>
            ...
            <form action="<?= $baseUrl ?>uploads/upload_attachment.php" method="POST" enctype="multipart/form-data" class="upload-form">
                <!-- Campo CSRF añadido -->
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
